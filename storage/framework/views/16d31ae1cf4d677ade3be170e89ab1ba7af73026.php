...
<head>
  ...
  <meta name="keywords" content="">
    ...
    <!-- Favicons -->
    <link href="<?php echo e(asset('img/Pikachu-Cap.png')); ?>" rel="icon">
...
<header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <div class="header-social-links">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-sm ml-2">Register</a>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
            <h2><span>We're </span><span class="underlight">Captured Moments, </span> a Professional<span> Photography Team Based in Kathmandu</span></h2>
            <p>We specialize in capturing life's most beautiful and unforgettable moments. With years of experience, our team of passionate photographers creates stunning visual stories that leave lasting impressions.</p>
...
</html><?php /**PATH /media/ananda/NightOwl/Download-SSD/Downloads/mylaravelproject/resources/views/frontend/layout.blade.php ENDPATH**/ ?>